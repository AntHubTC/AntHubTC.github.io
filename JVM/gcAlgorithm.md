...
![image-20200712102205795](img/gcAlgorithm/image-20200712102205795.png)
...
![image-20200712103230349](img/gcAlgorithm/image-20200712103230349.png)
...
![image-20200712104149246](img/gcAlgorithm/image-20200712104149246.png)

官场上的裙带关系，可达性分析在人类关系网中

![image-20200712104312406](img/gcAlgorithm/image-20200712104312406.png)
...
![image-20200712104622677](img/gcAlgorithm/image-20200712104622677.png)
...
![image-20200712110411885](img/gcAlgorithm/image-20200712110411885.png)
...
![image-20200712112026317](img/gcAlgorithm/image-20200712112026317.png)
...
![image-20200712112512720](img/gcAlgorithm/image-20200712112512720.png)
...
![image-20200712113256075](img/gcAlgorithm/image-20200712113256075.png)
...
上述代码就是不断的创建一个1M的字节数组，然后让内存溢出，我们需要限制一下内存大小，同时使用HeapDumpOnOutOfMemoryError将出错时候的dump文件输出
...
![image-20200712150229048](img/gcAlgorithm/image-20200712150229048.png)

然后我们通过线程，还能够定位到哪里出现OOM

![image-20200712150303710](img/gcAlgorithm/image-20200712150303710.png)
...
![image-20200712150935078](img/gcAlgorithm/image-20200712150935078.png)
...
![image-20200712151916991](img/gcAlgorithm/image-20200712151916991.png)

把可达的对象，直接复制到另外一个区域中复制完成后，A区就没有用了，里面的对象可以直接清除掉，其实里面的新生代里面就用到了复制算法

![image-20200712152029615](img/gcAlgorithm/image-20200712152029615.png)
...
![image-20200712152847218](img/gcAlgorithm/image-20200712152847218.png)
...
标记一清除算法的确可以应用在老年代中，但是该算法不仅执行效率低下，而且在执行完内存回收后还会产生内存碎片，JVM进。标记-压缩（Mark-Compact）算法由此诞生。
...
![image-20200712153236508](img/gcAlgorithm/image-20200712153236508.png)
...
![image-20200712165318590](img/gcAlgorithm/image-20200712165318590.png)
